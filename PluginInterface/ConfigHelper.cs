...
namespace FreeSWITCH.Helpers
{
    public abstract class fsConfigDocument
    {
        ...
        public Int64 WriteXML(System.IO.Stream outStream)
        {
    ...
    public class fsConfigFileDocument : fsConfigDocument
    {
        public fsConfigFileDocument(String configName, XElement body)
            : base("configuration")
        {
            SectionChild(new XElement("configuration",
                new XAttribute("name", configName),
                new XAttribute("description", configName + " -- description"),
                body));
        }
    }
    ...
    public class fsGroupDirectoryDocument : fsConfigDocument
    {
        public fsGroupDirectoryDocument(String domain, String groupName, IEnumerable<String> users )
            :base("directory")
        {
    ...
    public static class ConfigExtensions
    {
        ...
        //{
        //    e.ForEach((n, v) => Log.WriteLine(LogLevel.Debug, "{0}={1}", n, v));
        //}
